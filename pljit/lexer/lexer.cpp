...
auto pljit::lexer::lexer::next() -> std::optional<token> {
    discardWhitespace();
    if(input_iter == eos) {
...
auto pljit::lexer::lexer::parse_singleton() -> std::optional<token> {
...
auto pljit::lexer::lexer::parse_keyword(source_management::SourceFragment fragment) -> std::optional<token> {
...
pljit::source_management::SourcePosition pljit::lexer::lexer::get_current_position() const {
    return input_iter;
}
